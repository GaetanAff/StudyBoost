...
const upload = multer({ 
  ...
  fileFilter: (req, file, cb) => {
    const allowedTypes = /pdf|doc|docx|ppt|pptx|jpg|jpeg|png|odt/;
    ...
    if (mimetype && extname) {
      ...
      cb(new Error('Type de fichier non supporté. Formats autorisés : PDF, DOC, DOCX, PPT, PPTX, JPG, JPEG, PNG, ODT.'));
    }
  },
